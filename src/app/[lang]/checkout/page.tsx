...
function getTierMap(lang: string): Record<string, TierDetail> {
  const isEn = lang === "en";
  return {
    full: {
      id: "full",
      ...
      price: 140,
      variant: isEn ? "Full Seminar (2 Days)" : "Seminario Completo (2 Giorni)",
      dates: isEn ? "7 & 8 September 2026 • Bracciano, Italy" : "7 & 8 Settembre 2026 • Bracciano, Italia",
    },
    day1: {
      id: "day1",
      name: "Universal Method Seminar Pass",
      price: 80,
      variant: isEn ? "Day 1 Pass — Perceive" : "Pass Giorno 1 — Percepire",
      dates: isEn ? "7 September 2026 (17:00 – 20:00) • Bracciano, Italy" : "7 Settembre 2026 (17:00 – 20:00) • Bracciano, Italia",
    },
    day2: {
      id: "day2",
      name: "Universal Method Seminar Pass",
      price: 80,
      variant: isEn ? "Day 2 Pass — Adapt" : "Pass Giorno 2 — Adattarsi",
      dates: isEn ? "8 September 2026 (10:00 – 13:00) • Bracciano, Italy" : "8 Settembre 2026 (10:00 – 13:00) • Bracciano, Italia",
    },
  };
}
...
function CheckoutContent() {
  ...
  const tierMap = getTierMap(lang);
  const tierInfo = tierMap[tierKey] || tierMap.full;
  ...
  const handleApplyDiscount = (e: React.FormEvent) => {
    ...
    if (discountCode.trim().toUpperCase() === "UMS10") {
      ...
      alert(lang === "en" ? "Discount code UMS10 applied!" : "Codice sconto UMS10 applicato!");
    } else if (discountCode.trim()) {
      alert(lang === "en" ? "Invalid discount code." : "Codice sconto non valido.");
    }
  };
    ...
    return (
      <div className={styles.checkoutPage}>
        <div className={styles.topHeader}>
          <Link href={`/${lang}`} className={styles.brandName}>
        ...
        <div className={styles.successOverlay}>
          ...
          <span style={{ fontSize: "11px", letterSpacing: "0.2em", color: "#2b6e59", fontWeight: 700, textTransform: "uppercase" }}>
            {lang === "en" ? "RESERVATION SECURED" : "PRENOTAZIONE CONFERMATA"}
          </span>
          <h1 style={{ fontSize: "32px", fontWeight: 700, margin: "6px 0", color: "#111111" }}>
            {dict.modal.youAreIn}
          </h1>
          <p style={{ color: "#555555", fontSize: "14px", marginBottom: "24px" }}>
            {lang === "en" ? "Registration confirmed for" : "Registrazione confermata per"} <strong>{firstName || (lang === "en" ? "Participant" : "Partecipante")} {lastName}</strong>.
          </p>
          ...
          <div className={styles.successTicketCard}>
            ...
            <div className={styles.ticketGrid}>
              <div>
                <span className={styles.ticketLabel}>{lang === "en" ? "PARTICIPANT" : "PARTECIPANTE"}</span>
                <span className={styles.ticketValue}>{firstName || (lang === "en" ? "Participant" : "Partecipante")} {lastName}</span>
              </div>
              <div>
                <span className={styles.ticketLabel}>{lang === "en" ? "PASS TYPE" : "TIPO DI PASS"}</span>
                <span className={styles.ticketValueAccent}>{tierInfo.variant}</span>
              </div>
              <div>
                <span className={styles.ticketLabel}>{lang === "en" ? "DATES" : "DATE"}</span>
                <span className={styles.ticketValue}>{tierInfo.dates}</span>
              </div>
              <div>
                <span className={styles.ticketLabel}>{lang === "en" ? "LOCATION" : "LUOGO"}</span>
          ...
          <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            >
              {lang === "en" ? "Download Calendar (.ics)" : "Scarica Calendario (.ics)"}
            </button>
            <Link
              href={`/${lang}`}
              style={{
            ...
            >
              {lang === "en" ? "Back to Site" : "Torna al Sito"}
            </Link>
          </div>
        </div>
      </div>
    ...
    <div className={styles.checkoutPage}>
        ...
        <div className={styles.topSummaryInner}>
          ...
          >
            <div className={styles.toggleLeft}>
              ...
              <span>{lang === "en" ? "Show order summary and discount code" : "Mostra riepilogo ordine e codice sconto"}</span>
          ...
          {isSummaryOpen && (
            <div className={styles.summaryExpandedContent}>
              ...
              <form className={styles.discountRow} onSubmit={handleApplyDiscount}>
                <input
                  type="text"
                  placeholder={lang === "en" ? "Discount code" : "Codice sconto"}
      ...
      <div className={styles.formContainer}>
        <div className={styles.expressSection}>
          <span className={styles.expressTitle}>{lang === "en" ? "Express checkout" : "Check-out rapido"}</span>
        ...
        <div className={styles.orDivider}>
          <span>{lang === "en" ? "OR" : "OPPURE"}</span>
        </div>

        <form onSubmit={handlePayNow}>
          <div className={styles.sectionBlock}>
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>{lang === "en" ? "Contact" : "Contatti"}</h2>
            </div>
            ...
            <div className={styles.inputGroup}>
              <input
                type="text"
                required
                placeholder={lang === "en" ? "Email or mobile phone number" : "Email o numero di telefono cellulare"}
                value={contactInfo}
            ...
            <label className={styles.checkboxLabel}>
              ...
              />
              <span>{lang === "en" ? "Email me with news and seminar updates" : "Inviami email con notizie e offerte del seminario"}</span>
            </label>
          </div>

          <div className={styles.sectionBlock}>
            <h2 className={styles.sectionTitle}>{lang === "en" ? "Participant Details" : "Dati Partecipante"}</h2>
            <p className={styles.sectionSubtitle}>{lang === "en" ? "Enter your details for seminar registration." : "Inserisci i tuoi dati per la registrazione al seminario."}</p>
            ...
            <div className={styles.inputGroup} style={{ marginTop: "14px" }}>
              <select defaultValue="Italia">
                ...
                <option value="Altro">{lang === "en" ? "Other Country" : "Altro Paese"}</option>
              </select>
            </div>
            ...
            <div className={styles.inputGroup}>
              <input
                type="text"
                placeholder={lang === "en" ? "Address" : "Indirizzo"}
                value={address}
            ...
            <div className={styles.inputRow}>
              <div className={styles.inputGroup}>
                <input
                  type="text"
                  placeholder={lang === "en" ? "Postal Code" : "CAP"}
                  value={postalCode}
              ...
              <div className={styles.inputGroup}>
                <input
                  type="text"
                  placeholder={lang === "en" ? "City" : "Città"}
                  value={city}
            ...
            <div className={styles.inputRow}>
              ...
              <div className={styles.inputGroup}>
                ...
                >
                  <option value="beginner">{lang === "en" ? "1 - 2 Years Experience" : "1 - 2 Anni Esperienza"}</option>
                  <option value="intermediate">{lang === "en" ? "3 - 5 Years Experience" : "3 - 5 Anni Esperienza"}</option>
                  <option value="advanced">{lang === "en" ? "Advanced / Black Belt" : "Avanzato / Cintura Nera"}</option>
                  <option value="instructor">{lang === "en" ? "Academy Instructor" : "Istruttore Accademia"}</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className={styles.sectionBlock}>
            <h2 className={styles.sectionTitle}>{lang === "en" ? "Payment" : "Pagamento"}</h2>
            <p className={styles.sectionSubtitle}>{lang === "en" ? "All transactions are secure and encrypted." : "Tutte le transazioni sono sicure e crittografate."}</p>
              ...
              <div className={styles.paymentOption}>
                ...
                >
                  <div className={styles.radioTitle}>
                    ...
                    />
                    <span>{lang === "en" ? "Credit Card" : "Carta di credito"}</span>
                  </div>
                  ...
                  <div className={styles.cardBody}>
                    <div className={styles.inputGroup}>
                      <input
                        type="text"
                        required
                        placeholder={lang === "en" ? "Card number" : "Numero carta"}
                        maxLength={19}
                        value={cardNumber}
                    ...
                    <div className={styles.inputRow}>
                      <div className={styles.inputGroup}>
                        <input
                          type="text"
                          required
                          placeholder={lang === "en" ? "Expiration date (MM/YY)" : "Data di scadenza (MM/AA)"}
                          maxLength={5}
                          value={cardExpiry}
                      ...
                      <div className={styles.inputGroup}>
                        <input
                          type="password"
                          required
                          placeholder={lang === "en" ? "Security code" : "Codice di sicurezza"}
                          maxLength={4}
                          value={cardCvc}
                    ...
                    <div className={styles.inputGroup}>
                      <input
                        type="text"
                        placeholder={lang === "en" ? "Name on card" : "Nome sulla carta"}
                        value={cardName}
            ...
            >
              {isSubmitting
                ? (lang === "en" ? "Processing..." : "Elaborazione in corso...")
                : `${lang === "en" ? "Pay now" : "Paga ora"} • €${finalTotal},00`}
            </button>
          </div>
        </form>
      </div>
